...
extension Alamofire.DataRequest {
    ...
    /// Adds a handler to be called once the request has finished.
//    public func responsePropertyList(queue: DispatchQueue = .main, options: PropertyListSerialization.ReadOptions = PropertyListSerialization.ReadOptions()) -> Promise<(plist: Any, response: PMKAlamofireDataResponse)> {
//        return Promise { seal in
